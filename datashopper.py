...
def searchDatabase(query, outFile, startRec=0):
	client = yummly.Client(api_id='5dd6a908', api_key='1144f281d7ac2e4d2f08ba7883bdc396')
	results = client.search(query, start=startRec)
...
#	res = searchDatabase("bread", outFile, 0)
	res = searchDatabase("cake", outFile, 0)
#	res = searchDatabase("cookies", outFile, 0)
